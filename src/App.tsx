...
function RealitySection() {
  return (
    <section
      className="bg-black w-full py-30 sm:py-28 lg:py-35 px-6 sm:px-8 lg:px-12 relative border-t border-white/[0.03] sm:border-t-0"
...
function RoadmapSection() {
  ...
  return (
    <section
      className="bg-white/[0.02] sm:bg-black w-full py-30 sm:py-28 lg:py-35 px-6 sm:px-8 lg:px-12 relative overflow-hidden border-t border-white/[0.03] sm:border-t-0"
...
function OutcomesSection() {
  ...
  return (
    <section
      className="bg-black w-full py-30 sm:py-28 lg:py-35 px-4 sm:px-6 relative overflow-hidden border-t border-white/[0.03] sm:border-t-0"
