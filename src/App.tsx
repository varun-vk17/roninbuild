...
function Navigation() {
  ...
  return (
    ...
    >
      {/* Background layer with blur - positioned behind content */}
      <div
        className={`absolute inset-0 transition-all duration-300 ${scrolled
          ? "bg-black/70 backdrop-blur-md border-b border-white/[0.05]"
          : "bg-transparent"
          }`}
        aria-hidden="true"
      />

      {/* Content layer - always sharp and clear */}
      <div className="relative flex items-center justify-between px-[24px] sm:px-[48px] py-[20px] max-w-[1400px] mx-auto w-full">
        <Logo />
      ...
      <div className="max-w-[1400px] mx-auto relative">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-6 text-center sm:text-left">
            ...
            {/* Quote card */}
            <ScaleIn delay={0.8} className="w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-6">
          {steps.map((step, index) => (
            <ScaleIn key={index} delay={0.1 * index}>
              <div
                className="bg-gradient-to-br from-white/8 to-white/[0.02] backdrop-blur-lg rounded-[24px] p-10 border border-white/10 hover:border-[#6B5FFF]/40 transition-all duration-300 hover:scale-[1.02] group relative overflow-hidden cursor-pointer h-full"
              >
                {/* Bottom glow effect */}
                <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#6B5FFF] to-transparent" aria-hidden="true" />
      ...
      <div className="max-w-[1300px] mx-auto relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-6">
          {outcomes.map((outcome, index) => (
            <ScaleIn key={index} delay={0.1 * index}>
              <div
                className="bg-gradient-to-br from-white/8 to-white/[0.02] backdrop-blur-lg rounded-[30px] p-8 border border-white/10 hover:border-[#6B5FFF]/40 shadow-xl transition-all duration-300 hover:scale-[1.02] group relative overflow-hidden cursor-pointer h-full"
              >
                {/* Bottom glow effect */}
                <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#6B5FFF] to-transparent" aria-hidden="true" />
                <div className="absolute bottom-0 left-0 right-0 h-[60px] bg-gradient-to-t from-[#6B5FFF]/20 via-[#6B5FFF]/5 to-transparent blur-xl group-hover:from-[#6B5FFF]/30 transition-colors duration-300" aria-hidden="true" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-6 mb-10 sm:mb-16">
          {packages.map((pkg, index) => (
            <ScaleIn key={index} delay={0.2 * index}>
              <div
                className={`relative bg-gradient-to-br backdrop-blur-lg rounded-[40px] p-8 sm:p-10 shadow-xl transition-all duration-300 hover:scale-[1.02] group overflow-visible h-full ${pkg.featured
              ...
              >
                ...
                <div className="mb-8 relative z-50 flex items-baseline gap-2 isolate">
                  ...
                  <span
                    className="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[32px] sm:text-[36px]"
                    style={{ color: '#4ade80', opacity: 1, textShadow: '0 0 20px rgba(74, 222, 128, 0.3)' }}
                  >
                    {pkg.price}
                  </span>
                </div>
...
export default function App() {
  return (
    <>
      ...
      <div className="bg-black content-stretch flex flex-col items-center relative min-h-screen w-full overflow-x-hidden antialiased">
        <GradientBackground />
        <FloatingParticles />
